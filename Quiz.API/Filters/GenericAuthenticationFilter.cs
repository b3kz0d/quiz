...
namespace Quiz.API.Filters
{
    ...
    public class GenericAuthenticationFilter : AuthorizationFilterAttribute
    {
        ...
        protected virtual BasicAuthenticationIdentity FetchAuthHeader(HttpActionContext filterContext)
        {
            ...
            if (authRequest != null && !String.IsNullOrEmpty(authRequest.Scheme) && authRequest.Scheme == "Basic")// && authRequest.Scheme == "Basic"
        ...
        private static void ChallengeAuthRequest(HttpActionContext filterContext)
        {
            ...
            filterContext.Response = filterContext.Request.CreateResponse(HttpStatusCode.Unauthorized, "Unauthorized");
